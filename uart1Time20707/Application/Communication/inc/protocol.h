...
/*-----------------通信协议串口配置-------------------*/
//上下行串口定义
//#define	FEEDBACK_CMD_TXBUF		((USART_Buf_TypeDef *)&TxBuf_Struct2)
//#define	SET_CMD_RXBUF					((USART_Buf_TypeDef *)&RxBuf_Struct2)	
...
#define RECEIVE_DATA_MAX_LENGTH  ((uint8_t)28) 	    //(2+24+2)
